...
! function(e, t, n) {
    ...
    function h(t, r) {
        ...
        if ("CSS" in e && "supports" in e.CSS) {
            for (; i--;)
                if (e.CSS.supports(v(t[i]), r)) return !0;
            return !1
        }
    ...
    function g(e, t, i, o) {
        ...
        for (var A, d, c, p, v, g = ["modernizr", "tspan", "samp"]; !D.style && g.length;) A = !0, D.modElem = s(g.shift()), D.style = D.modElem.style;
    ...
    _.hasEvent = b, Modernizr.addTest("inlinesvg", function() {
        var e = s("div");
        return e.innerHTML = "<svg/>", "http://www.w3.org/2000/svg" == ("undefined" != typeof SVGRect && e.firstChild && e.firstChild.namespaceURI)
    });
    var x = _._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
    _._prefixes = x, Modernizr.addTest("csscalc", function() {
        var e = "width:",
            t = "calc(10px);",
            n = s("a");
    ...
    Modernizr._q.unshift(function() {
        delete D.style
    }), _.testAllProps = m, _.testAllProps = y, Modernizr.addTest("cssfilters", function() {
    ...
    }), Modernizr.addTest("pagevisibility", !!M("hidden", t, !1)), Modernizr.addTest("objectfit", !!M("objectFit"), {
        aliases: ["object-fit"]
